  ...
  return (
    <>
      <Head>
        ...
        <title>Privacy Policy | Ryzira</title>
      </Head>
      <style jsx global>{`
        :root {
          --bg: #0f1115;
      ...
      <div className="container">
        <div className="card">
          ...
          <div className="updated">Last updated: January 05, 2023</div>
          <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Ryzira.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to Ryzira, accessible from{" "}
                <Link href="/">
          ...
          <ul>
            <li>By email: hi@kishanjoshi.dev</li>
          </ul>
        ...
        <footer>© Ryzira. All rights reserved.</footer>
      </div>
    </>
  );
}
